          ...
          child: ListView(
            children: <Widget>[
              ...
              InkWell(
                ...
                onTap: (){
                  Navigator.push(context,MaterialPageRoute(builder: (context) =>ProfilePage("Register")));
                },
              ),
              Divider(thickness: 2,color: Colors.grey,),
              InkWell(
                ...
                onTap: (){
                  Navigator.push(context,MaterialPageRoute(builder: (context) =>ProfilePage("Profile")));
                },
              ),
